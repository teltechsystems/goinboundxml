...
func TestNewResponse(t *testing.T) {
	...
	if response.String() != "<?xml version=\"1.0\" encoding=\"utf-8\"?><Response><Record maxLength=\"60\" playBeep=\"false\" /></Response>" {
		t.Errorf("Unexpected string generated by response")
	}
	...
	if response.String() != "<?xml version=\"1.0\" encoding=\"utf-8\"?><Response><Record action=\"http://www.example.com/recording-callback\" maxLength=\"60\" playBeep=\"false\" /></Response>" {
		t.Errorf("Unexpected string generated by response")
	}
}
