...
func TestNewResponse(t *testing.T) {
	...
	if response.String() != "<?xml version=\"1.0\" encoding=\"utf-8\"?><Response><Pause length=\"3\" /></Response>" {
		t.Errorf("Unexpected string generated by response", response.String())
	}

	response.Reset()
	response.Record(&RecordAttrs{MaxLength: 60})

	if response.String() != "<?xml version=\"1.0\" encoding=\"utf-8\"?><Response><Record maxLength=\"60\" playBeep=\"false\" background=\"false\" /></Response>" {
		t.Errorf("Unexpected string generated by response")
	}
	...
	if response.String() != "<?xml version=\"1.0\" encoding=\"utf-8\"?><Response><Record action=\"http://www.example.com/recording-callback\" maxLength=\"60\" playBeep=\"false\" background=\"false\" /></Response>" {
		t.Errorf("Unexpected string generated by response")
	}
}
